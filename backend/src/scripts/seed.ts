    ...
    const sampleWorkouts = [
        {
            ...
            exercises: [
                {
                    exercise: exercises[0]._id, // Push-ups
                    sets: [
                ...
                {
                    exercise: exercises[3]._id, // Bench Press
                    sets: [
        ...
        },
        {
            ...
            exercises: [
                {
                    exercise: exercises[5]._id, // Running
                    sets: [
                        { duration: 1200, distance: 3000, completed: true }, // 20 min, 3km
                    ],
                },
                {
                    exercise: exercises[7]._id, // Burpees
                    sets: [
        ...
        },
        {
            ...
            exercises: [
                {
                    exercise: exercises[1]._id, // Squats
                    sets: [
                ...
                {
                    exercise: exercises[4]._id, // Pull-ups
                    sets: [
...
const seedGoals = async () => {
    ...
    const sampleGoals = [
        ...
        },
        {
            ...
            currentValue: 35,
            unit: 'km',
            targetDate: new Date(Date.now() + 25 * 24 * 60 * 60 * 1000), // 25 days from now
        },
        {
            user: users[1]._id,
        ...
        },
        {
            ...
            currentValue: 12,
            unit: 'workouts',
            targetDate: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000), // 20 days from now
        },
    ];
...
const seedPosts = async () => {
    ...
    const workouts = await Workout.find({ isTemplate: false }).limit(2);
